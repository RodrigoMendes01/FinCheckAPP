    ...
    <div>
      <DropdownMenu.Root>
        <DropdownMenu.Trigger>
          <button
            className={cn('bg-white rounded-lg w-full border border-gray-500 px-3 h-[52px] text-gray-700 focus:border-gray-800 transition-all outline-none text-left relative', error && '!border-red-900 z-50', className
            )}
          >
            Cor

            <div
              className='text-gray-800 absolute right-3 top-1/2 -translate-y-1/2'
            >
              {selectedColor && (
